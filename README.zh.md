...
| 企业 | 核心平台 | SGLang | vLLM | 自研引擎 | 精度支持 | 代表产品 |
|------|----------|--------|------|----------|----------|---------|
| **华为昇腾** | CANN 9.0.0 | [✅ 官方原生](https://docs.sglang.ai/docs/hardware-platforms/ascend-npus/ascend_npu) | [✅ v0.18.0](https://github.com/vllm-project/vllm-ascend) | MindIE | FP16/BF16/INT4 | 910B / 910C / 950 |
| **寒武纪** | NeuWare / BANG | ❌ 不支持 | [✅ v0.11.2-dev](https://github.com/Cambricon/vllm-mlu) | MagicMind | FP16/INT8 | 思元 590 / 370 |
| **沐曦股份** | MXMACA | ❌ 不支持 | [✅ v0.20.0](https://github.com/MetaX-MACA/vLLM-metax) | — | FP16/BF16/INT8 | 曦云 C500 |
| **壁仞科技** | BIRENSUPA | ❌ 不支持 | ❌ 暂无公开仓库 | — | FP16/BF16 | 壁砺 166 |
| **摩尔线程** | MUSA | ❌ 不支持 | [✅ v0.22.0-dev](https://github.com/MooreThreads/vllm-musa) | — | FP16/BF16/INT8 | MTT S系列 |
| **海光信息** | DTK (ROCm) | ❌ 不支持 | [✅ v0.8.5 镜像](https://developer.sourcefind.cn/servicelist/detail?post_id=61036870-b3c7-11f0-9989-acde48001122&active=TagDownload) | — | FP16/BF16/FP32 | 深算 K100 / Z100 |
| **天数智芯** | IXUCA SDK | ❌ 不支持 | [✅ DeepSparkInference](https://github.com/Deep-Spark/DeepSparkInference) | IxRT + IGIE | FP16/INT8/INT4 | 天垓150 / 智铠100 |
| **清微智能** ⚠️ | RAISA / FlagOS | ❌ 不支持 | ⚠️ [vllm-plugin-FL](https://github.com/flagos-ai/vllm-plugin-FL)（间接） | FlagScale | FP16/BF16 | TX81 |
| **芯动科技** | FTUCA | [✅ 风华官网](https://www.fantasyxpu.com/product/gr308smax) | [✅ 风华官网](https://www.fantasyxpu.com/product/gr308smax) | FantRT | TF32/FP16/BF16/INT8 | GR308S MAX / GR308S |

### 国产 GPU 硬件规格对照

| 企业 | 代表产品 | 显存容量 | 显存带宽 | 互联方案 | FP16 算力 | 特色 |
|------|---------|---------|---------|---------|----------|------|
| **华为昇腾** | 910C | 64GB HBM | ~1.5 TB/s | HCCS | ~320 TFLOPS | PD 分离部署，CANN 生态最完整 |
| **寒武纪** | 思元 590 | 48GB HBM | ~1.2 TB/s | CNCL | 345 TFLOPS | 性价比突出，5D 混合并行 |
| **沐曦** | 曦云 C500 | 48GB HBM | ~1.3 TB/s | PCIe 5.0 | ~300 TFLOPS | CUDA 兼容度高 |
| **壁仞** | 壁砺 166 | 64GB HBM | ~1.5 TB/s | BILink | ~360 TFLOPS | 安全可靠 I 级认证 |
| **摩尔线程** | MTT S系列 | 32GB GDDR6 | ~700 GB/s | PCIe 5.0 | ~200 TFLOPS | 全功能 GPU，社区驱动 |
| **海光** | 深算 K100 | 64GB HBM | ~1.0 TB/s | PCIe | ~200 TFLOPS | ROCm 生态兼容 |
| **天数智芯** | 天垓150 | 48GB HBM | ~1.2 TB/s | PCIe 4.0 | ~280 TFLOPS | TVM 自研引擎 |
| **清微智能** | TX81 | — | — | TSM-LINK | — | CGRA 数据流架构 |
| **芯动科技** | GR308S MAX | 112GB GDDR6 | 2240 GB/s | PCIe 5.0 | — | SGLang+vLLM 双支持 |

---

## DeepSeek 模型国产 GPU 适配

DeepSeek-V3.1/R1/V4 系列 MoE 大模型对 EP（Expert Parallelism）等高级并行策略有较高要求，是检验国产 GPU 推理能力的重要基准。

| 厂商 | DeepSeek-V3.1 | DeepSeek-R1 蒸馏 | DeepSeek-V4 | 备注 |
|------|--------------|-----------------|-------------|------|
| **华为昇腾** | ✅ SGLang / vLLM | ✅ | ✅ | CANN 9.0.0 + DeepEP 兼容库，支持 PD 分离 |
| **寒武纪** | ✅ vllm-mlu | ✅ | ✅ **day0** | 2026/4/24 宣布 day0 支持，MLU 370+ |
| **沐曦** | ✅ vLLM-metax | ✅ | — | 官方团队持续跟进 |
| **摩尔线程** | ✅ vllm-musa | ⚠️ 待验证 | — | MUSA 社区驱动 |
| **天数智芯** | ✅ DeepSparkInference | ✅ R1 全系蒸馏 | — | IXUCA 4.4.0，已验证 R1-Distill 全系列 |
| **芯动科技** | ✅ 官网列明 | ✅ | — | GR308S MAX 8卡可运行满血 671B |
| **海光** | ⚠️ 可运行（vLLM） | ⚠️ 可运行 | — | 双卡 TP 已验证 Qwen3-8B |
| **壁仞** | ❌ 无公开资料 | ❌ | — | 需关注官方邀测 |
| **清微智能** | ⚠️ 通过 FlagOS | ⚠️ | — | CGRA 架构，间接支持 |
...
**最新动态（2026 年 6 月）：**
- vLLM-Ascend 最新稳定版 [v0.18.0](https://github.com/vllm-project/vllm-ascend/releases/tag/v0.18.0)（2026/4），已对齐 vLLM v0.18.0
- SGLang 昇腾支持 [v0.5.10-npu](https://docs.sglang.ai/docs/hardware-platforms/ascend-npus/ascend_npu)，CANN 9.0.0 + HDK 25.5.2
- 支持 PD 分离部署（MemFabric-Hybrid KV Cache 传输）、多模态模型（Qwen3-VL 等）
- 提供 [DeepEP 兼容库](https://github.com/sgl-project/sgl-kernel-npu)作为 DeepSeek-ai DeepEP 的替代方案
- Triton on Ascend（triton-ascend 3.2.1）已可用
...
| SGLang 昇腾文档 | https://docs.sglang.ai/docs/hardware-platforms/ascend-npus/ascend_npu |
...
**最新动态（2026 年 4~6 月）：**
- vllm-mlu [v0.11.2-dev](https://github.com/Cambricon/vllm-mlu) — day0 支持 **DeepSeek-V4**（2026/4/24 宣布）
- 已覆盖 Transformer、MoE、多模态等主流模型架构
- 基于 vLLM 插件系统开发，支持 Chunk Prefill、Prefix Caching、Spec Decode、Graph Mode 等特性
...
**最新动态（2026 年 6 月）：**
- vLLM-metax 最新版 [v0.20.0](https://github.com/MetaX-MACA/vLLM-metax/releases/tag/v0.20.0)（2026/6），已对齐 vLLM v0.20.0，支持 Gemma4 等新模型
- 持续按月发布新版本，与上游 vLLM 版本同步节奏
- 提供 Docker 镜像，支持曦云 C500 系列
...
| vLLM-MetaX 文档 | https://vllm-metax.readthedocs.io/en/latest/ |
...
**最新动态（2026 年 6 月）：**
- vllm-musa [v0.22.0-dev](https://github.com/MooreThreads/vllm-musa) — 基于 vLLM V1 engine 架构，支持 vLLM 插件系统
- 核心组件成熟：torchada（CUDA→MUSA 兼容层）、MATE（MUSA AI Tensor Engine）、torch_musa（PyTorch 后端）
- 支持 ccache 加速本地编译，开发体验持续优化
...
| torchada（CUDA 兼容层） | https://github.com/MooreThreads/torchada |
...
**最新动态（2026 年 4~6 月）：**
- DeepSparkInference 已验证 **50+ LLM 模型**，覆盖 Qwen3（含 MoE 235B）、DeepSeek-V3.1、DeepSeek-R1 全系列蒸馏版、ERNIE-4.5、MiniCPM-o-2 等多模态模型
- 与百度飞桨合作黑客松活动（2026/3~6），基于天垓150 硬件
- SDK 已更新至 IXUCA 4.4.0，支持更多新模型
...
- **vLLM：** DeepSparkInference 已验证 50+ LLM 模型，覆盖 Qwen3（含 235B MoE）、DeepSeek-V3.1/R1、Llama3、ChatGLM、ERNIE-4.5 全系列
...
**硬件亮点（GR308S MAX，经官网确认）：**
- 显存：112GB GDDR6，带宽 **2240 GB/s**（国产卡中最高级别）
- AI 框架：原生支持 PyTorch、**vLLM、SGLang**、FantRT
- 编程模型：HIP（类 CUDA）、Triton
- 支持精度：TF32、FP16、BF16、INT8（均支持稀疏计算）
- 接口：PCIe 5.0 x16，支持 SR-IOV 虚拟化
- 编解码：AV1/H.265/H.264 硬件编解码

| 资源 | 链接 |
|------|------|
| 风华创智官网 | https://www.fantasyxpu.com |
| GR308S MAX 产品页 | https://www.fantasyxpu.com/product/gr308smax |
...
- **SGLang + vLLM 双支持：** GR308S MAX 产品规格明确列出 PyTorch、vLLM、SGLang、FantRT（已验证官网产品页）
- **大模型能力：** 单机八卡 GR308S MAX（112GB/卡）可运行满血版 DeepSeek 671B 和 Qwen3-235B
